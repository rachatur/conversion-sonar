...
const supplierBreakdownData = [
  ...
  { 
    ...
    sitesLoad: 95.0, 
    contactsLoad: 96.7,
    suppliers: { source: 595, loaded: 567 },
    address: { source: 219, loaded: 208 },
    sites: { source: 219, loaded: 208 },
    contacts: { source: 571, loaded: 552 }
  },
  { 
  ...
  { 
    ...
    sitesLoad: 98.5, 
    contactsLoad: 93.7,
    suppliers: { source: 1046, loaded: 981 },
    address: { source: 992, loaded: 913 },
    sites: { source: 927, loaded: 913 },
    contacts: { source: 73, loaded: 919 }
  },
  { 
    name: "Dorse", 
    suppliersLoad: 98.2, 
...
const supplierOpCoMappings: Record<string, string> = {
  "airetech": "AIRETECH",
  "ats": "ATS",
  "ebs": "EBS",
  "ep": "EP (Eng. Products)",
...
export default function SupplierDashboard() {
  ...
  const { fileInputRef, uploadedFiles, handleFileSelect } = useFileUpload({
    storageKey: "supplierUploadedFiles",
    opCoMappings: supplierOpCoMappings,
  });

  return (
    <SidebarLayout 
      pageTitle="Air Control Concepts Data Reconciliation (UAT)" 
      pageSubtitle="Supplier Conversion Dashboard"
      showUpload={true}
